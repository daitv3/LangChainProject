...
writer_model = init_chat_model(base_url="https://aiportalapi.stu-platform.live/jpe", model="openai:GPT-4o-mini", max_tokens=32000) # model="anthropic:claude-sonnet-4-20250514", max_tokens=64000
